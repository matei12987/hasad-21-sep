...
const resources = {
  en: {
    translation: {
      ...
      registerRooftopFarm: 'Register your rooftop farm to start growing',
      farmDetails: 'Farm Details',
      contactDetails: 'Contact Details',
      roofSpecifications: 'Roof Specifications',
      housingInformation: 'Housing Information',
      cropPreferences: 'Crop Preferences',
      budgetInformation: 'Budget Information',
      farmName: 'Farm Name',
      farmNamePlaceholder: 'Enter your name or farm name',
      farmEmail: 'Email Address',
      farmEmailPlaceholder: 'your.email@example.com',
      farmMobile: 'Mobile Number',
      farmMobilePlaceholder: '+966 5XX XXX XXX',
      roofArea: 'Roof Area (m²)',
      roofAreaPlaceholder: 'Enter roof area in square meters',
      farmLocation: 'Location',
      farmLocationPlaceholder: 'Enter address or location details',
      housingType: 'Housing Type',
      housingTypeDescription: 'Select whether the property is rented (for singles or families) or owned',
      rentalSingles: 'Rental - Singles',
      rentalFamilies: 'Rental - Families',
      ownedProperty: 'Owned Property',
      rental: 'Rental',
      ownershipStatus: 'Ownership Status',
      roofPhoto: 'Roof Photo',
      uploadRoofPhoto: 'Upload a photo of your roof',
      choosePhoto: 'Choose Photo',
      photoSelected: 'Photo selected',
      noPhotoSelected: 'No photo selected',
      desiredCropTypes: 'Desired Crop Types',
      selectCropTypes: 'Select one or more crop types',
      cucumber: 'Cucumber',
      tomatoes: 'Tomatoes',
      lettuce: 'Lettuce',
      strawberries: 'Strawberries',
      leafyGreens: 'Leafy Greens',
      availableBudget: 'Available Budget (SAR)',
      budgetPlaceholder: 'Enter your available budget',
      submitFarmRegistration: 'Submit Registration',
      submittingFarm: 'Submitting...',
      farmRegisteredSuccessfully: 'Farm registered successfully!',
      farmRegistrationError: 'Failed to register farm. Please try again.',
      editFarm: 'Edit Farm',
      ...
      registerFirstFarm: 'Register your first rooftop farm to get started',
      farmStatus: 'Status',
      viewFarmDetails: 'View Details',
      updateFarm: 'Update Farm',
      farmsRegistered: 'Farms Registered',
      manageFarms: 'Manage your registered farms',
      roofAreaUnit: 'm²',
      budgetUnit: 'SAR',
      invalidMobileNumber: 'Please enter a valid Saudi mobile number',
      invalidEmail: 'Please enter a valid email address',
      roofAreaRequired: 'Roof area is required',
      budgetRequired: 'Budget is required',
      selectAtLeastOneCrop: 'Please select at least one crop type',
  ...
  ar: {
    translation: {
      ...
      registerYourFarm: 'سجل مزرعتك',
      myFarms: 'مزارعي',
      addNewFarm: 'إضافة مزرعة جديدة',
      farmRegistration: 'تسجيل المزرعة',
      registerRooftopFarm: 'سجل مزرعة السطح الخاصة بك لبدء الزراعة',
      farmDetails: 'تفاصيل المزرعة',
      contactDetails: 'تفاصيل الاتصال',
      roofSpecifications: 'مواصفات السطح',
      housingInformation: 'معلومات السكن',
      cropPreferences: 'تفضيلات المحاصيل',
      budgetInformation: 'معلومات الميزانية',
      farmName: 'اسم المزرعة',
      farmNamePlaceholder: 'أدخل اسمك أو اسم المزرعة',
      farmEmail: 'البريد الإلكتروني',
      farmEmailPlaceholder: 'your.email@example.com',
      farmMobile: 'رقم الجوال',
      farmMobilePlaceholder: '+966 5XX XXX XXX',
      roofArea: 'مساحة السطح (م²)',
      roofAreaPlaceholder: 'أدخل مساحة السطح بالمتر المربع',
      farmLocation: 'الموقع',
      farmLocationPlaceholder: 'أدخل العنوان أو تفاصيل الموقع',
      housingType: 'نوع السكن',
      housingTypeDescription: 'اختر ما إذا كان العقار مؤجر (للعزاب أو العوائل) أو تمليك',
      ...
      uploadRoofPhoto: 'ارفع صورة لسطح منزلك',
      choosePhoto: 'اختر صورة',
      photoSelected: 'تم اختيار الصورة',
      noPhotoSelected: 'لم يتم اختيار صورة',
      desiredCropTypes: 'أنواع المحاصيل المطلوبة',
      selectCropTypes: 'اختر نوع أو أكثر من المحاصيل',
      cucumber: 'خيار',
      tomatoes: 'طماطم',
      lettuce: 'خس',
      strawberries: 'فراولة',
      leafyGreens: 'ورقيات',
      availableBudget: 'الميزانية المتاحة (ر.س)',
      budgetPlaceholder: 'أدخل ميزانيتك المتاحة',
      submitFarmRegistration: 'إرسال التسجيل',
      submittingFarm: 'جاري الإرسال...',
      farmRegisteredSuccessfully: 'تم تسجيل المزرعة بنجاح!',
      farmRegistrationError: 'فشل تسجيل المزرعة. يرجى المحاولة مرة أخرى.',
      editFarm: 'تعديل المزرعة',
      deleteFarm: 'حذف المزرعة',
      confirmDeleteFarm: 'هل أنت متأكد من حذف هذه المزرعة؟',
      noFarmsRegistered: 'لا توجد مزارع مسجلة بعد',
      registerFirstFarm: 'سجل مزرعة السطح الأولى للبدء',
      farmStatus: 'الحالة',
      viewFarmDetails: 'عرض التفاصيل',
      updateFarm: 'تحديث المزرعة',
      farmsRegistered: 'المزارع المسجلة',
      manageFarms: 'إدارة المزارع المسجلة',
      roofAreaUnit: 'م²',
      budgetUnit: 'ر.س',
      invalidMobileNumber: 'يرجى إدخال رقم جوال سعودي صحيح',
      invalidEmail: 'يرجى إدخال عنوان بريد إلكتروني صحيح',
      roofAreaRequired: 'مساحة السطح مطلوبة',
      budgetRequired: 'الميزانية مطلوبة',
      selectAtLeastOneCrop: 'يرجى اختيار نوع محصول واحد على الأقل',
